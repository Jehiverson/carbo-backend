...
router.get("/logoAndSlogan", async(req, res) => {
   var data = await getDataCollection('LogoAndSlogan');
   res.json({data});
});

router.get("/logoAndSlogan/:id", async(req, res) => {
   console.log(req.params.id);
    var data = await getDataCollectionForId('LogoAndSlogan', req.params.id);
    res.json({data});
 });
...
/* router.post("/aboutus", async(req, res) => {
 ...
 router.patch("/logoAndSlogan", async(req, res) => {
    var dataUpdate = await updateDataCollection('LogoAndSlogan', req.body.id, req.body);
